...
/*   Updated: 2025/04/21 15:48:46 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Cat::Cat(void) : AAnimal("Cat"), _cat_brain(new Brain())
{
	std::cout << "CAT Default constructor" << std::endl;
	return ;
}

Cat::Cat(const Cat &rhs) : AAnimal("Cat"), _cat_brain(new Brain(*(rhs._cat_brain)))
{
