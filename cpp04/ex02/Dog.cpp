...
/*   Updated: 2025/04/21 15:48:39 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Dog::Dog(void) : AAnimal("Dog"), _dog_brain(new Brain())
{
	std::cout << "DOG Default constructor" << std::endl;
	return ;
}

Dog::Dog(const Dog &rhs) : AAnimal("Dog"), _dog_brain(new Brain(*(rhs._dog_brain)))
{
