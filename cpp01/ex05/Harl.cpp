...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/28 16:44:29 by codespace         #+#    #+#             */
/*   Updated: 2025/03/28 18:35:22 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	typedef void	(Harl::*MemFuncPtr)(void) const;
	
	std::string levels[] = {"DEBUG", "INFO", "WARNING", "ERROR"};
	MemFuncPtr	functions[] = {&Harl::debug, &Harl::info, &Harl::warning, &Harl::error};
	for (int i = 0; i < 4; i++)
	{
		if (levels[i] == level)
		{
